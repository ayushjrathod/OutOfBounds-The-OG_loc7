  ...
  return (
    <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
      ...
      <GridItem
        ...
        description="Reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla."
      />
  ...
  return (
    <li className={`min-h-[14rem] list-none ${area}`}>
      <div className="relative h-full rounded-2.5xl border border-white/10 p-2 md:rounded-3xl md:p-3">
        ...
        <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl bg-white/5 backdrop-blur-md p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D] md:p-6">
